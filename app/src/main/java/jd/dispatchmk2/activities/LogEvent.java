package jd.dispatchmk2.activities;
...
public class LogEvent extends AppCompatActivity {

    private String TAG = "LogEvent Activity:";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get address
        //on button, shared preference save
        final TextView logEventAddressView = (TextView) findViewById(R.id.event_address_textbox);
        ...
        logEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String address = logEventAddressView.getText().toString();
                saveInputAsSharedPrefs(address);
            }
        });
